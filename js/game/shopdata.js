 ...
 *
 * All Phases through Final + new additions:
 * - 7 avatars (6 original + Golden Doctor secret unlock)
 * - 30+ shop items across skins, hats, trails, and gear
 * - Rebalanced prices for abundant coin economy
 * - 6 quests with scaled rewards
 * - 21 achievement badge definitions (20 original + Golden Doctor)
 * - Continue cost constant
 *
 * NEW:
 * - Golden Doctor avatar (Item 15): hidden until ach_golden_doctor
 *   is unlocked by completing a run with 0 wrong and 20+ correct.
 *   Price is 0 (free once unlocked). Gold-themed colors.
 * - ach_golden_doctor achievement definition
 */
...
export var AVATARS = [
    ...
    // ===== NEW: Golden Doctor — secret unlock (Item 15) =====
    {
        id: "avatar_golden",
        name: "Golden Doctor",
        ...
        armSwing: 1.0,
        icon: "🏆",
        hidden: true  // UI checks this + achievement to show/hide
    }
];
...
export var SHOP_ITEMS = [
    ...
    // NEW: Golden Doctor — hidden until ach_golden_doctor unlocked
...
export var ACHIEVEMENTS = [
    ...
    // ===== NEW: Golden Doctor secret achievement (Item 15) =====
